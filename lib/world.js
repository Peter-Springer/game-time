...
class World {
  ...
  //     this.balls.forEach(ball => {
  //       ball.collisionWithBrickRight(b.x, b.y, b.height, b.width)
  //     })
  //   })
  // }
  //
  ...
  //   this.bricks.forEach(b => {
  //     this.balls.forEach(ball => {
  //       ball.collisionWithBrickLeft(b.x, b.y, b.height, b.width)
  //     })
  //   })
  // }
  //
  ...
  //   this.bricks.forEach(b => {
  //     this.balls.forEach(ball => {
  //       ball.collisionWithBrickTop(b.x, b.y, b.height, b.width)
  //     })
  //   })
  // }
  //
  // brickDetectionBottom() {
  //   this.bricks.forEach(b => {
  //     this.balls.forEach(ball => {
  //       ball.collisionWithBrickBottom(b.x, b.y, b.height, b.width)
  //     })
  //   })
  // }
  brickDetection() {
